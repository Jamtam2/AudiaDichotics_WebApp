...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/custom_tabs.js"***REMOVED***;
/******/ ***REMOVED******REMOVED***
/************************************************************************/
/******/ ({

/***/ "./app/javascript/packs/custom_tabs.js":
/*!*********************************************!*\
  !*** ./app/javascript/packs/custom_tabs.js ***!
  \*********************************************/
...
document.addEventListener('DOMContentLoaded', function (***REMOVED*** {
  var defaultTab = document.getElementById('users-tab'***REMOVED***;
  if (!defaultTab.classList.contains('active'***REMOVED******REMOVED*** {
    defaultTab.classList.add('active'***REMOVED***;
  ***REMOVED***
  var defaultTabContent = document.getElementById('users-content'***REMOVED***;
  if (!defaultTabContent.classList.contains('active'***REMOVED******REMOVED*** {
    defaultTabContent.classList.add('active'***REMOVED***;
  ***REMOVED***
***REMOVED******REMOVED***;
...
/******/ ***REMOVED******REMOVED***;
//# sourceMappingURL=custom_tabs-8d3784691ad55996e9e2.js.map