...
#age in years method that calculates a clients age based on DOB then passes it to the script test page
  ...
  def self.ransackable_attributes(auth_object = nil***REMOVED***
    %w(id address1 city country date_of_birth email first_name gender last_name mgmt_ref phone1 phone2 race state zip created_at updated_at tenant_id age_in_years age ***REMOVED*** + _ransackers.keys
  end
