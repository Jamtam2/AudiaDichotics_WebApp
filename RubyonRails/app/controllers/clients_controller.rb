class ClientsController < ApplicationController
    ...
    def client_params
      params.require(:client***REMOVED***.permit(:first_name, :last_name, :date_of_birth, :email, :gender, :mgmt_ref, :address1, :country, :state, :city, :zip, :phone1, :phone2,
        emergency_contacts_attributes: [:id, :first_name, :last_name, :phone_number, :address, :email, :city, :state]***REMOVED***
    end
