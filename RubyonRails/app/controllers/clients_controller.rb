class ClientsController < ApplicationController
 ...
 require 'csv'
    ...
    def update_registration_key
      ...
      Rails.logger.info("---------------------------------"***REMOVED***
      Rails.logger.info("---------------------------------"***REMOVED***
      Rails.logger.info("DEBUG: WE ALTEAST GOT IN HERE"***REMOVED***
      Rails.logger.info("---------------------------------"***REMOVED***
      Rails.logger.info("---------------------------------"***REMOVED***
      Rails.logger.info("---------------------------------"***REMOVED***
      ...
      Rails.logger.info("---------------------------------"***REMOVED***
      Rails.logger.info("---------------------------------"***REMOVED***
      Rails.logger.info("DEBUG:UPDATED USER KEY: #{key.inspect***REMOVED***"***REMOVED***
      Rails.logger.info("---------------------------------"***REMOVED***
      Rails.logger.info("---------------------------------"***REMOVED***
      Rails.logger.info("---------------------------------"***REMOVED***
      ...
      if key.present? && !key.used
        ...
        user.update(verification_key: verification_key***REMOVED***
        curr_key.update(email:  "OLDKEYSFOR#{user.email***REMOVED***"***REMOVED***
