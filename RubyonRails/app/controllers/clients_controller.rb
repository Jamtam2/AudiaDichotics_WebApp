 ...
 require 'csv'
  ...
  def new
    ...
    def global_moderator_index
      ...
      process_hashed_search_parameters(***REMOVED***
...
def process_hashed_search_parameters
  ...
  #   address_records = HashedDatum.where(hashed_address: address_search_term***REMOVED***
  #                                .or(HashedDatum.where(hashed_state: address_search_term***REMOVED******REMOVED***
  #                                .or(HashedDatum.where(hashed_city: address_search_term***REMOVED******REMOVED***
  #                                .or(HashedDatum.where(hashed_country: address_search_term***REMOVED******REMOVED***
  #                                .or(HashedDatum.where(hashed_zip: address_search_term***REMOVED******REMOVED***
  #   @clients = @clients.where(id: address_records.pluck(:hashable_id***REMOVED******REMOVED*** if address_records.exists?
  # end
  #
  # if params[:email_search].present?
  #   email_search_term = Digest::SHA256.hexdigest(params[:email_search].to_s***REMOVED***
  #   email_records = HashedDatum.where(hashed_email: email_search_term***REMOVED***
  #   @clients = @clients.where(id: email_records.pluck(:hashable_id***REMOVED******REMOVED*** if email_records.exists?
  # end
